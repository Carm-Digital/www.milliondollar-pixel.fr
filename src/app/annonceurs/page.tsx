  ...
  return (
    <div className="min-h-screen bg-[#0b0b0f] text-zinc-100">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <h1 className="text-3xl font-bold text-white mb-2">Annonceurs</h1>
        <p className="text-zinc-400 mb-10">
          Tous les acheteurs qui ont rejoint le mur. {ads.length} annonceur{ads.length !== 1 ? 's' : ''} à ce jour.
        </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-zinc-500 text-xs mt-0.5">{formatDate(ad.purchase_date)}</p>
                  </div>
                  <svg
